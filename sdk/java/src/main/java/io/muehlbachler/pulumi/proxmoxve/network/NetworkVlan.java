...
public class NetworkVlan extends com.pulumi.resources.CustomResource {
     ...
     */
    public NetworkVlan(java.lang.String name) {
     ...
     */
    public NetworkVlan(java.lang.String name, NetworkVlanArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NetworkVlan(java.lang.String name, NetworkVlanArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("proxmoxve:Network/networkVlan:NetworkVlan", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NetworkVlan(java.lang.String name, Output<java.lang.String> id, @Nullable NetworkVlanState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("proxmoxve:Network/networkVlan:NetworkVlan", name, state, makeResourceOptions(options, id), false);
    }

    private static NetworkVlanArgs makeArgs(NetworkVlanArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? NetworkVlanArgs.Empty : args;
    }
     ...
     */
    public static NetworkVlan get(java.lang.String name, Output<java.lang.String> id, @Nullable NetworkVlanState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
