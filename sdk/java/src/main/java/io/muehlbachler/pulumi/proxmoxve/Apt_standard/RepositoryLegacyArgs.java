...
public final class RepositoryLegacyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The handle of the APT standard repository. Must be `ceph-squid-enterprise` | `ceph-squid-no-subscription` | `ceph-squid-test` | `enterprise` | `no-subscription` | `test`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param handle The handle of the APT standard repository. Must be `ceph-squid-enterprise` | `ceph-squid-no-subscription` | `ceph-squid-test` | `enterprise` | `no-subscription` | `test`.
         * 
         * @return builder
         * 
         */
