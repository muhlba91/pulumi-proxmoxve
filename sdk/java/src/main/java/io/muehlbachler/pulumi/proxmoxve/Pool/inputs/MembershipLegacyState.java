...
public final class MembershipLegacyState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Resource pool membership type (can be `vm` for VMs and CTs or `storage` for storages)
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param type Resource pool membership type (can be `vm` for VMs and CTs or `storage` for storages)
         * 
         * @return builder
         * 
         */
