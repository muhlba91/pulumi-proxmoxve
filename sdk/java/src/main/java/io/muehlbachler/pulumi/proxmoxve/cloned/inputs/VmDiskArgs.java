...
public final class VmDiskArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Disk size (GiB) when creating new disks. **Note:** Disk shrinking is not supported. Attempting to set `sizeGb` to a value smaller than the current disk size will result in an error. Only disk expansion is allowed.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param sizeGb Disk size (GiB) when creating new disks. **Note:** Disk shrinking is not supported. Attempting to set `sizeGb` to a value smaller than the current disk size will result in an error. Only disk expansion is allowed.
         * 
         * @return builder
         * 
         */
