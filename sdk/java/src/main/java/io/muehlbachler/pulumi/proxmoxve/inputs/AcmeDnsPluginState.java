...
public final class AcmeDnsPluginState extends com.pulumi.resources.ResourceArgs {

    public static final AcmeDnsPluginState Empty = new AcmeDnsPluginState();
    ...
    private AcmeDnsPluginState() {}

    private AcmeDnsPluginState(AcmeDnsPluginState $) {
        this.api = $.api;
        this.data = $.data;
        this.digest = $.digest;
    ...
    public static Builder builder(AcmeDnsPluginState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AcmeDnsPluginState();
        }

        public Builder(AcmeDnsPluginState defaults) {
            $ = new AcmeDnsPluginState(Objects.requireNonNull(defaults));
        }
        ...
        public AcmeDnsPluginState build() {
            return $;
        }
    }
