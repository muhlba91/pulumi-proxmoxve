...
public final class OptionsLegacyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param crsHa Cluster resource scheduling setting for HA. Must be `static` | `basic` | `dynamic` (default is `basic`). `dynamic` requires Proxmox VE 9.2+.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param crsHaAutoRebalanceHoldDuration The number of HA rounds for which the cluster node imbalance threshold must be exceeded before triggering an automatic resource balancing migration (default is `3`). Requires Proxmox VE 9.2+.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param crsHaAutoRebalanceMargin The minimum relative improvement in cluster node imbalance, in percent, to commit to a resource balancing migration. Must be between `0` and `100` (default is `10`). Requires Proxmox VE 9.2+.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param crsHaAutoRebalanceMethod The method to use for the scoring of balancing migrations. Must be `bruteforce` | `topsis` (default is `bruteforce`). Requires Proxmox VE 9.2+.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param crsHaAutoRebalanceThreshold The cluster node imbalance, in percent, which will trigger the automatic resource balancing system if exceeded. Must be between `0` and `100` (default is `30`). Requires Proxmox VE 9.2+.
         * 
         * @return builder
         * 
         */
