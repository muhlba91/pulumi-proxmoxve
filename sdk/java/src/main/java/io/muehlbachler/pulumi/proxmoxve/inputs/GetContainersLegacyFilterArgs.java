...
public final class GetContainersLegacyFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Name of the container attribute to filter on. One of [`name`, `template`, `status`, `nodeName`]
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param name Name of the container attribute to filter on. One of [`name`, `template`, `status`, `nodeName`]
         * 
         * @return builder
         * 
         */
