...
public final class LVMThinState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="lvmThinId")
    private @Nullable Output<String> lvmThinId;

    /**
     * @return The unique identifier of the storage.
     * 
     */
    public Optional<Output<String>> lvmThinId() {
        return Optional.ofNullable(this.lvmThinId);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder lvmThinId(@Nullable Output<String> lvmThinId) {
            $.lvmThinId = lvmThinId;
            return this;
        }
