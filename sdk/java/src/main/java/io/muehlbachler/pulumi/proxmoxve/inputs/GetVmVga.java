...
public final class GetVmVga extends com.pulumi.resources.InvokeArgs {

    public static final GetVmVga Empty = new GetVmVga();
    ...
    public static final class Builder {
        ...
        public Builder(GetVmVga defaults) {
            $ = new GetVmVga(Objects.requireNonNull(defaults));
        }
