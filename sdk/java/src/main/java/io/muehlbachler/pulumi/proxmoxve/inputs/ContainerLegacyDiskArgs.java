...
public final class ContainerLegacyDiskArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Whether to include this volume in a storage replication job (defaults to `true`).
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param replicate Whether to include this volume in a storage replication job (defaults to `true`).
         * 
         * @return builder
         * 
         */
