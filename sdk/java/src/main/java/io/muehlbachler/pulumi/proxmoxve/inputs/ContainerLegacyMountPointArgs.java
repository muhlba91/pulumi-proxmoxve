...
public final class ContainerLegacyMountPointArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Will include this volume to a storage replica job (defaults to `true`).
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param replicate Will include this volume to a storage replica job (defaults to `true`).
         * 
         * @return builder
         * 
         */
