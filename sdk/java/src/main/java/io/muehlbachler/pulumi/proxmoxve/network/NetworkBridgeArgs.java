...
public final class NetworkBridgeArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetworkBridgeArgs Empty = new NetworkBridgeArgs();
    ...
    private NetworkBridgeArgs() {}

    private NetworkBridgeArgs(NetworkBridgeArgs $) {
    ...
    public static Builder builder(NetworkBridgeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkBridgeArgs();
        }

        public Builder(NetworkBridgeArgs defaults) {
            $ = new NetworkBridgeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetworkBridgeArgs build() {
            if ($.nodeName == null) {
                throw new MissingRequiredPropertyException("NetworkBridgeArgs", "nodeName");
            }
            return $;
        }
    }
