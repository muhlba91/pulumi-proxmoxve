...
public final class GroupAclArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GroupAclArgs() {}

    private GroupAclArgs(GroupAclArgs $) {
        this.path = $.path;
    ...
    public static Builder builder(GroupAclArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GroupAclArgs defaults) {
