...
public final class GetVmVgaArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetVmVgaArgs Empty = new GetVmVgaArgs();
    ...
    private GetVmVgaArgs() {}

    private GetVmVgaArgs(GetVmVgaArgs $) {
    ...
    public static Builder builder(GetVmVgaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetVmVgaArgs defaults) {
            $ = new GetVmVgaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVmVgaArgs build() {
            if ($.clipboard == null) {
                throw new MissingRequiredPropertyException("GetVmVgaArgs", "clipboard");
            }
            if ($.memory == null) {
                throw new MissingRequiredPropertyException("GetVmVgaArgs", "memory");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("GetVmVgaArgs", "type");
            }
            return $;
        }
    }
