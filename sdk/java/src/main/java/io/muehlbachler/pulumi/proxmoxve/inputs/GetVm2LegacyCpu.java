...
public final class GetVm2LegacyCpu extends com.pulumi.resources.InvokeArgs {

    public static final GetVm2LegacyCpu Empty = new GetVm2LegacyCpu();
    ...
    private GetVm2LegacyCpu(GetVm2LegacyCpu $) {
    ...
    public static final class Builder {
        ...
        public Builder(GetVm2LegacyCpu defaults) {
            $ = new GetVm2LegacyCpu(Objects.requireNonNull(defaults));
        }
        ...
        public GetVm2LegacyCpu build() {
            ...
            if ($.hotplugged == null) {
                throw new MissingRequiredPropertyException("GetVm2LegacyCpu", "hotplugged");
            }
            if ($.limit == null) {
