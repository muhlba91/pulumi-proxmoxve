...
public final class NetworkVlanState extends com.pulumi.resources.ResourceArgs {

    public static final NetworkVlanState Empty = new NetworkVlanState();
    ...
    private NetworkVlanState() {}

    private NetworkVlanState(NetworkVlanState $) {
    ...
    public static Builder builder(NetworkVlanState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkVlanState();
        }

        public Builder(NetworkVlanState defaults) {
            $ = new NetworkVlanState(Objects.requireNonNull(defaults));
        }
