...
public final class FileLegacyState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<String> uploadMode;
    ...
    public static final class Builder {
        ...
        /**
         * @param sourceFile The source file (conflicts with `sourceRaw`),
         * could be a local file or a URL. If the source file is a URL, the file will
         * be downloaded and stored locally before uploading it to Proxmox VE.
         * 
         * @return builder
        ...
        /**
         * @param sourceRaw The raw source (conflicts with `sourceFile`).
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder uploadMode(@Nullable Output<String> uploadMode) {
        ...
        public Builder uploadMode(String uploadMode) {
            return uploadMode(Output.of(uploadMode));
        }
