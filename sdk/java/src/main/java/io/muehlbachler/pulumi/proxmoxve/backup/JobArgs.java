...
public final class JobArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Deprecated: use pruneBackups instead. Maximum number of backup files per guest.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param maxfiles Deprecated: use pruneBackups instead. Maximum number of backup files per guest.
         * 
         * @return builder
         * 
         */
