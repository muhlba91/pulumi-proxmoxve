...
public final class HaruleState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The resource affinity type (resource-affinity only). `positive` keeps resources on the same node, `negative` keeps them on separate nodes.
     * 
     */
    ...
    /**
     * @return Whether the HA rule is disabled. Defaults to `false`.
     * 
     */
    ...
    /**
     * @return The member nodes for this rule (node-affinity only). They are provided as a map, where the keys are the node names and the values represent their priority: integers for known priorities or `null` for unset priorities.
     * 
     */
    ...
    /**
     * @return Whether the node affinity rule is strict (node-affinity only). When strict, resources cannot run on nodes not listed. Defaults to `false`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param affinity The resource affinity type (resource-affinity only). `positive` keeps resources on the same node, `negative` keeps them on separate nodes.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param disable Whether the HA rule is disabled. Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param nodes The member nodes for this rule (node-affinity only). They are provided as a map, where the keys are the node names and the values represent their priority: integers for known priorities or `null` for unset priorities.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param strict Whether the node affinity rule is strict (node-affinity only). When strict, resources cannot run on nodes not listed. Defaults to `false`.
         * 
         * @return builder
         * 
         */
