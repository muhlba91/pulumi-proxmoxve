...
public final class ClonedVirtualMachineVgaArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClonedVirtualMachineVgaArgs Empty = new ClonedVirtualMachineVgaArgs();
    ...
    private ClonedVirtualMachineVgaArgs() {}

    private ClonedVirtualMachineVgaArgs(ClonedVirtualMachineVgaArgs $) {
    ...
    public static Builder builder(ClonedVirtualMachineVgaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClonedVirtualMachineVgaArgs();
        }

        public Builder(ClonedVirtualMachineVgaArgs defaults) {
            $ = new ClonedVirtualMachineVgaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClonedVirtualMachineVgaArgs build() {
            return $;
        }
    }
