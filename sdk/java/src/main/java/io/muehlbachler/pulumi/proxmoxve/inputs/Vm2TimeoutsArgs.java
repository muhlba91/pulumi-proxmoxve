...
public final class Vm2TimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final Vm2TimeoutsArgs Empty = new Vm2TimeoutsArgs();
    ...
    private Vm2TimeoutsArgs() {}

    private Vm2TimeoutsArgs(Vm2TimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.read = $.read;
        this.update = $.update;
    ...
    public static Builder builder(Vm2TimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Vm2TimeoutsArgs defaults) {
            $ = new Vm2TimeoutsArgs(Objects.requireNonNull(defaults));
        }
