...
public class AcmeDnsPlugin extends com.pulumi.resources.CustomResource {
     ...
     */
    public AcmeDnsPlugin(String name) {
     ...
     */
    public AcmeDnsPlugin(String name, AcmeDnsPluginArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("proxmoxve:index/acmeDnsPlugin:AcmeDnsPlugin", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private AcmeDnsPlugin(String name, Output<String> id, @Nullable AcmeDnsPluginState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("proxmoxve:index/acmeDnsPlugin:AcmeDnsPlugin", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AcmeDnsPlugin get(String name, Output<String> id, @Nullable AcmeDnsPluginState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
