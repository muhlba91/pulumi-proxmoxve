...
public final class GetVm2LegacyVga extends com.pulumi.resources.InvokeArgs {

    public static final GetVm2LegacyVga Empty = new GetVm2LegacyVga();
    ...
    private GetVm2LegacyVga(GetVm2LegacyVga $) {
    ...
    public static final class Builder {
        ...
        public Builder(GetVm2LegacyVga defaults) {
            $ = new GetVm2LegacyVga(Objects.requireNonNull(defaults));
        }
