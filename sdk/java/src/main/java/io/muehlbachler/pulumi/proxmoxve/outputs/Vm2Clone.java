...
public final class Vm2Clone {
    ...
    public static Builder builder(Vm2Clone defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer retries;
        public Builder() {}
        public Builder(Vm2Clone defaults) {
        ...
        public Builder id(Integer id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("Vm2Clone", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Vm2Clone build() {
            final var _resultValue = new Vm2Clone();
            _resultValue.id = id;
