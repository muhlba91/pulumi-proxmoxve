...
public final class LVMArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="lvmId", required=true)
    private Output<String> lvmId;

    /**
     * @return The unique identifier of the storage.
     * 
     */
    public Output<String> lvmId() {
        return this.lvmId;
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param lvmId The unique identifier of the storage.
         * 
         * @return builder
         * 
         */
        public Builder lvmId(Output<String> lvmId) {
            $.lvmId = lvmId;
            return this;
        }
         ...
         * 
         */
        public Builder lvmId(String lvmId) {
            return lvmId(Output.of(lvmId));
        }
        ...
        public LVMArgs build() {
            if ($.lvmId == null) {
                throw new MissingRequiredPropertyException("LVMArgs", "lvmId");
            }
            if ($.volumeGroup == null) {
