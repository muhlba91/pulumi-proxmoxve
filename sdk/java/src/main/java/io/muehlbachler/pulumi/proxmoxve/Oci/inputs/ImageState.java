...
public final class ImageState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return By default `true`. If `true` and the OCI image size has changed in the datastore, it will be replaced. If `false`, there will be no check.
     * 
     */
    ...
    /**
     * @return If `true` and an OCI image with the same name already exists in the datastore, it will be deleted and the new image will be pulled. If `false` and the image already exists, an error will be returned.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param overwrite By default `true`. If `true` and the OCI image size has changed in the datastore, it will be replaced. If `false`, there will be no check.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param overwriteUnmanaged If `true` and an OCI image with the same name already exists in the datastore, it will be deleted and the new image will be pulled. If `false` and the image already exists, an error will be returned.
         * 
         * @return builder
         * 
         */
