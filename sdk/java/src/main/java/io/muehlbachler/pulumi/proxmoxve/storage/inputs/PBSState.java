...
public final class PBSState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="pbsId")
    private @Nullable Output<String> pbsId;

    /**
     * @return The unique identifier of the storage.
     * 
     */
    public Optional<Output<String>> pbsId() {
        return Optional.ofNullable(this.pbsId);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder pbsId(@Nullable Output<String> pbsId) {
            $.pbsId = pbsId;
            return this;
        }
