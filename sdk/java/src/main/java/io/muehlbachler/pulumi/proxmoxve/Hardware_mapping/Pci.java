...
public class Pci extends com.pulumi.resources.CustomResource {
     ...
     */
    public Pci(String name, PciArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("proxmoxve:Hardware/mapping/pci:Pci", name, args == null ? PciArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Pci(String name, Output<String> id, @Nullable PciState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("proxmoxve:Hardware/mapping/pci:Pci", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static Pci get(String name, Output<String> id, @Nullable PciState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
