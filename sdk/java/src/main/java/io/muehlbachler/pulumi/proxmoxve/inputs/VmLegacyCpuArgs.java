...
public final class VmLegacyCpuArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The CPU architecture (defaults to `x8664`).
     * 
     */
    ...
    /**
     * @return Enable/disable NUMA (defaults to `false`).
     * 
     */
    ...
    /**
     * @return The CPU units. PVE default is `1024` for cgroups v1 and `100` for cgroups v2.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param architecture The CPU architecture (defaults to `x8664`).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param numa Enable/disable NUMA (defaults to `false`).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param units The CPU units. PVE default is `1024` for cgroups v1 and `100` for cgroups v2.
         * 
         * @return builder
         * 
         */
