...
public final class PluginArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Version counter for `dataWo`. Because write-only values are not stored in state, Terraform cannot detect when `dataWo` changes; increment this value to signal a rotation and force the new `dataWo` to be sent.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param dataWoVersion Version counter for `dataWo`. Because write-only values are not stored in state, Terraform cannot detect when `dataWo` changes; increment this value to signal a rotation and force the new `dataWo` to be sent.
         * 
         * @return builder
         * 
         */
