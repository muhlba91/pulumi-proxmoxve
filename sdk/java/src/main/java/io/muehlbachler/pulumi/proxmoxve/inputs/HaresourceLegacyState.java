...
public final class HaresourceLegacyState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The type of HA resources to create. If unset, it will be deduced from the `resourceId`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param type The type of HA resources to create. If unset, it will be deduced from the `resourceId`.
         * 
         * @return builder
         * 
         */
