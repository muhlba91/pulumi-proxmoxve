...
public final class LVMState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="lvmId")
    private @Nullable Output<String> lvmId;

    /**
     * @return The unique identifier of the storage.
     * 
     */
    public Optional<Output<String>> lvmId() {
        return Optional.ofNullable(this.lvmId);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder lvmId(@Nullable Output<String> lvmId) {
            $.lvmId = lvmId;
            return this;
        }
