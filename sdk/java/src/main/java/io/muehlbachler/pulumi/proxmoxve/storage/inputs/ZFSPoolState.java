...
public final class ZFSPoolState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="zfsPoolId")
    private @Nullable Output<String> zfsPoolId;

    /**
     * @return The unique identifier of the storage.
     * 
     */
    public Optional<Output<String>> zfsPoolId() {
        return Optional.ofNullable(this.zfsPoolId);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder zfsPoolId(@Nullable Output<String> zfsPoolId) {
            $.zfsPoolId = zfsPoolId;
            return this;
        }
