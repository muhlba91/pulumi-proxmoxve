...
public final class GetVm2LegacyRng extends com.pulumi.resources.InvokeArgs {

    public static final GetVm2LegacyRng Empty = new GetVm2LegacyRng();
    ...
    private GetVm2LegacyRng(GetVm2LegacyRng $) {
    ...
    public static final class Builder {
        ...
        public Builder(GetVm2LegacyRng defaults) {
            $ = new GetVm2LegacyRng(Objects.requireNonNull(defaults));
        }
