...
public final class FirewallIPSetState extends com.pulumi.resources.ResourceArgs {
    ...
    private FirewallIPSetState() {}

    private FirewallIPSetState(FirewallIPSetState $) {
        this.cidrs = $.cidrs;
    ...
    public static Builder builder(FirewallIPSetState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirewallIPSetState();
        }

        public Builder(FirewallIPSetState defaults) {
            $ = new FirewallIPSetState(Objects.requireNonNull(defaults));
        }
        ...
        public FirewallIPSetState build() {
            return $;
        }
    }
