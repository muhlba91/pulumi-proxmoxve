...
public final class VirtualMachine2TimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final VirtualMachine2TimeoutsArgs Empty = new VirtualMachine2TimeoutsArgs();
    ...
    private VirtualMachine2TimeoutsArgs() {}

    private VirtualMachine2TimeoutsArgs(VirtualMachine2TimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.read = $.read;
        this.update = $.update;
    ...
    public static Builder builder(VirtualMachine2TimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualMachine2TimeoutsArgs();
        }

        public Builder(VirtualMachine2TimeoutsArgs defaults) {
            $ = new VirtualMachine2TimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VirtualMachine2TimeoutsArgs build() {
            return $;
        }
    }
