...
namespace Pulumi.ProxmoxVE.CT.Inputs
{
    ...
    public sealed class ContainerWaitForIpGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public ContainerWaitForIpGetArgs()
        {
        }
        public static new ContainerWaitForIpGetArgs Empty => new ContainerWaitForIpGetArgs();
    }
}
