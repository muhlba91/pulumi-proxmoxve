...
namespace Pulumi.ProxmoxVE.CT.Inputs
{
    ...
    public sealed class ContainerWaitForIpArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public ContainerWaitForIpArgs()
        {
        }
        public static new ContainerWaitForIpArgs Empty => new ContainerWaitForIpArgs();
    }
}
