...
namespace Pulumi.ProxmoxVE.VM
{
    ...
    /// </summary>
    [ProxmoxVEResourceType("proxmoxve:VM/virtualMachine2:VirtualMachine2")]
    public partial class VirtualMachine2 : global::Pulumi.CustomResource
    {
        ...
        public VirtualMachine2(string name, VirtualMachine2Args args, CustomResourceOptions? options = null)
            : base("proxmoxve:VM/virtualMachine2:VirtualMachine2", name, args ?? new VirtualMachine2Args(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachine2(string name, Input<string> id, VirtualMachine2State? state = null, CustomResourceOptions? options = null)
            : base("proxmoxve:VM/virtualMachine2:VirtualMachine2", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualMachine2 Get(string name, Input<string> id, VirtualMachine2State? state = null, CustomResourceOptions? options = null)
        {
            return new VirtualMachine2(name, id, state, options);
        }
    }

    public sealed class VirtualMachine2Args : global::Pulumi.ResourceArgs
    {
        [Input("cdrom")]
        ...
        {
            get => _cdrom ?? (_cdrom = new InputMap<Inputs.VirtualMachine2CdromArgs>());
            set => _cdrom = value;
        }
        ...
        public VirtualMachine2Args()
        {
        }
        public static new VirtualMachine2Args Empty => new VirtualMachine2Args();
    }

    public sealed class VirtualMachine2State : global::Pulumi.ResourceArgs
    {
        [Input("cdrom")]
        ...
        {
            get => _cdrom ?? (_cdrom = new InputMap<Inputs.VirtualMachine2CdromGetArgs>());
            set => _cdrom = value;
        }
        ...
        public VirtualMachine2State()
        {
        }
        public static new VirtualMachine2State Empty => new VirtualMachine2State();
    }
}
