...
// Whether to use CRS for balancing HA resources automatically depending on the current node imbalance. Requires Proxmox VE 9.2+.
func (o OptionsOutput) CrsHaAutoRebalance() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Options) pulumi.BoolPtrOutput { return v.CrsHaAutoRebalance }).(pulumi.BoolPtrOutput)
}

// The number of HA rounds for which the cluster node imbalance threshold must be exceeded before triggering an automatic resource balancing migration (default is `3`). Requires Proxmox VE 9.2+.
func (o OptionsOutput) CrsHaAutoRebalanceHoldDuration() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Options) pulumi.IntPtrOutput { return v.CrsHaAutoRebalanceHoldDuration }).(pulumi.IntPtrOutput)
}

// The minimum relative improvement in cluster node imbalance, in percent, to commit to a resource balancing migration. Must be between `0` and `100` (default is `10`). Requires Proxmox VE 9.2+.
func (o OptionsOutput) CrsHaAutoRebalanceMargin() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Options) pulumi.IntPtrOutput { return v.CrsHaAutoRebalanceMargin }).(pulumi.IntPtrOutput)
}

// The method to use for the scoring of balancing migrations. Must be `bruteforce` | `topsis` (default is `bruteforce`). Requires Proxmox VE 9.2+.
func (o OptionsOutput) CrsHaAutoRebalanceMethod() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Options) pulumi.StringPtrOutput { return v.CrsHaAutoRebalanceMethod }).(pulumi.StringPtrOutput)
}

// The cluster node imbalance, in percent, which will trigger the automatic resource balancing system if exceeded. Must be between `0` and `100` (default is `30`). Requires Proxmox VE 9.2+.
func (o OptionsOutput) CrsHaAutoRebalanceThreshold() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Options) pulumi.IntPtrOutput { return v.CrsHaAutoRebalanceThreshold }).(pulumi.IntPtrOutput)
}
