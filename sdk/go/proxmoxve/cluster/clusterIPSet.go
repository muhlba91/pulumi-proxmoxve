...
// List of IP or Networks
func (o ClusterIPSetOutput) Cidrs() ClusterIPSetCidrArrayOutput {
	return o.ApplyT(func(v *ClusterIPSet) ClusterIPSetCidrArrayOutput { return v.Cidrs }).(ClusterIPSetCidrArrayOutput)
}

// IPSet comment
func (o ClusterIPSetOutput) Comment() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ClusterIPSet) pulumi.StringPtrOutput { return v.Comment }).(pulumi.StringPtrOutput)
}

// IPSet name
func (o ClusterIPSetOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *ClusterIPSet) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}
