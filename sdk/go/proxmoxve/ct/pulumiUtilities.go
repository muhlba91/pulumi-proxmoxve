...
func pkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	defaults := []pulumi.ResourceOption{pulumi.PluginDownloadURL("github://api.github.com/muhlba91/pulumi-proxmoxve")}
...
func pkgInvokeDefaultOpts(opts []pulumi.InvokeOption) []pulumi.InvokeOption {
	defaults := []pulumi.InvokeOption{pulumi.PluginDownloadURL("github://api.github.com/muhlba91/pulumi-proxmoxve")}
