...
func NewHosts(ctx *pulumi.Context,
	...
	var resource Hosts
	err := ctx.RegisterResource("proxmoxve:Environment/hosts:Hosts", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHosts(ctx *pulumi.Context,
	...
	var resource Hosts
	err := ctx.ReadResource("proxmoxve:Environment/hosts:Hosts", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
