...
func NewDNS(ctx *pulumi.Context,
	...
	var resource DNS
	err := ctx.RegisterResource("proxmoxve:Environment/dNS:DNS", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDNS(ctx *pulumi.Context,
	...
	var resource DNS
	err := ctx.ReadResource("proxmoxve:Environment/dNS:DNS", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
