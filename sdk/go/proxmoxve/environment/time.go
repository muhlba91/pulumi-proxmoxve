...
func NewTime(ctx *pulumi.Context,
	...
	var resource Time
	err := ctx.RegisterResource("proxmoxve:Environment/time:Time", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTime(ctx *pulumi.Context,
	...
	var resource Time
	err := ctx.ReadResource("proxmoxve:Environment/time:Time", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
