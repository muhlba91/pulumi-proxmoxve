...
// Create the base directory if it doesn't exist.
func (o CifsLegacyOutput) CreateBasePath() pulumi.BoolOutput {
	return o.ApplyT(func(v *CifsLegacy) pulumi.BoolOutput { return v.CreateBasePath }).(pulumi.BoolOutput)
}

// Populate the directory with the default structure.
func (o CifsLegacyOutput) CreateSubdirs() pulumi.BoolOutput {
	return o.ApplyT(func(v *CifsLegacy) pulumi.BoolOutput { return v.CreateSubdirs }).(pulumi.BoolOutput)
}
...
// The mount options for the SMB/CIFS share (see 'man mount.cifs').
func (o CifsLegacyOutput) Options() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CifsLegacy) pulumi.StringPtrOutput { return v.Options }).(pulumi.StringPtrOutput)
}
