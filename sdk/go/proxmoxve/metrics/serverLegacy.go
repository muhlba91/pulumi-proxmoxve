...
// **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
// The InfluxDB access token (write-only). Prefer this over `influxToken` to avoid storing the secret in Terraform state. Cannot be used together with `influxToken`.
func (o ServerLegacyOutput) InfluxTokenWo() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ServerLegacy) pulumi.StringPtrOutput { return v.InfluxTokenWo }).(pulumi.StringPtrOutput)
}

// Increment this counter to rotate `influxTokenWo` without changing other fields.
func (o ServerLegacyOutput) InfluxTokenWoVersion() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *ServerLegacy) pulumi.IntPtrOutput { return v.InfluxTokenWoVersion }).(pulumi.IntPtrOutput)
}
