...
class GetTimeResult:
    ...
    def local_time(self) -> builtins.str:
        """
    ...
    def utc_time(self) -> builtins.str:
        """
...
def get_time(node_name: Optional[builtins.str] = None,
    ...
    :param builtins.str node_name: A node name.
    """
    __args__ = dict()
...
def get_time_output(node_name: Optional[pulumi.Input[builtins.str]] = None,
