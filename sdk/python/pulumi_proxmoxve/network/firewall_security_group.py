...
class FirewallSecurityGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: Security group comment.
        :param pulumi.Input[builtins.int] container_id: The ID of the container to manage the firewall for.
        :param pulumi.Input[builtins.str] name: Security group name.
        :param pulumi.Input[builtins.str] node_name: The name of the node.
        :param pulumi.Input[builtins.int] vm_id: The ID of the VM to manage the firewall for.
        """
...
class FirewallSecurityGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            node_name: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FirewallSecurityGroupRuleArgs', 'FirewallSecurityGroupRuleArgsDict']]]]] = None,
            vm_id: Optional[pulumi.Input[builtins.int]] = None) -> 'FirewallSecurityGroup':
        """
