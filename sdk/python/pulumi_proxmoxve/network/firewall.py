...
class FirewallArgs:
    def __init__(__self__, *,
                 ebtables: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] ebtables: Enable ebtables rules cluster wide.
        :param pulumi.Input[builtins.bool] enabled: Enable or disable the firewall cluster wide.
        :param pulumi.Input[builtins.str] input_policy: The default input policy (`ACCEPT`, `DROP`, `REJECT`).
        :param pulumi.Input['FirewallLogRatelimitArgs'] log_ratelimit: The log rate limit.
        :param pulumi.Input[builtins.str] output_policy: The default output policy (`ACCEPT`, `DROP`, `REJECT`).
        """
    ...
    @property
    @pulumi.getter
    def ebtables(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @ebtables.setter
    def ebtables(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Firewall(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            input_policy: Optional[pulumi.Input[builtins.str]] = None,
            log_ratelimit: Optional[pulumi.Input[Union['FirewallLogRatelimitArgs', 'FirewallLogRatelimitArgsDict']]] = None,
            output_policy: Optional[pulumi.Input[builtins.str]] = None) -> 'Firewall':
        """
    ...
    @property
    @pulumi.getter
    def ebtables(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable ebtables rules cluster wide.
        """
        return pulumi.get(self, "ebtables")
