...
class GetHostsResult:
    ...
    @property
    @pulumi.getter
    def hostnames(self) -> Sequence[Sequence[builtins.str]]:
        """
...
def get_hosts(node_name: Optional[builtins.str] = None,
...
def get_hosts_output(node_name: Optional[pulumi.Input[builtins.str]] = None,
