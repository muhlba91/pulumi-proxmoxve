...
class GetHAGroupResult:
    ...
    def no_failback(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def nodes(self) -> Mapping[str, builtins.int]:
        """
...
def get_ha_group(group: Optional[builtins.str] = None,
    ...
    :param builtins.str group: The identifier of the High Availability group to read.
    """
    __args__ = dict()
...
def get_ha_group_output(group: Optional[pulumi.Input[builtins.str]] = None,
