...
class HAGroupArgs:
    def __init__(__self__, *,
                 ...
                 nodes: pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]],
                 comment: Optional[pulumi.Input[builtins.str]] = None,
                 no_failback: Optional[pulumi.Input[builtins.bool]] = None,
                 restricted: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a HAGroup resource.
        :param pulumi.Input[builtins.str] group: The identifier of the High Availability group to manage.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]] nodes: The member nodes for this group. They are provided as a map, where the keys are the node names and the values represent their priority: integers for known priorities or `null` for unset priorities.
        :param pulumi.Input[builtins.str] comment: The comment associated with this group
        :param pulumi.Input[builtins.bool] no_failback: A flag that indicates that failing back to a higher priority node is disabled for this HA group. Defaults to `false`.
        :param pulumi.Input[builtins.bool] restricted: A flag that indicates that other nodes may not be used to run resources associated to this HA group. Defaults to `false`.
        """
    ...
    @property
    @pulumi.getter
    def nodes(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]]:
        """
    ...
    @nodes.setter
    def nodes(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]]):
    ...
    def no_failback(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @no_failback.setter
    def no_failback(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _HAGroupState:
    def __init__(__self__, *,
                 ...
                 no_failback: Optional[pulumi.Input[builtins.bool]] = None,
                 nodes: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]]] = None,
                 restricted: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter
    def nodes(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]]]:
        """
        The member nodes for this group. They are provided as a map, where the keys are the node names and the values represent their priority: integers for known priorities or `null` for unset priorities.
        """
        return pulumi.get(self, "nodes")
    ...
    @nodes.setter
    def nodes(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "nodes", value)
...
class HAGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            no_failback: Optional[pulumi.Input[builtins.bool]] = None,
            nodes: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]]] = None,
            restricted: Optional[pulumi.Input[builtins.bool]] = None) -> 'HAGroup':
        """
    ...
    @property
    @pulumi.getter(name="noFailback")
    def no_failback(self) -> pulumi.Output[builtins.bool]:
        """
        A flag that indicates that failing back to a higher priority node is disabled for this HA group. Defaults to `false`.
        """
        return pulumi.get(self, "no_failback")
    ...
    @property
    @pulumi.getter
    def nodes(self) -> pulumi.Output[Mapping[str, builtins.int]]:
        """
        The member nodes for this group. They are provided as a map, where the keys are the node names and the values represent their priority: integers for known priorities or `null` for unset priorities.
        """
        return pulumi.get(self, "nodes")
    ...
    @property
    @pulumi.getter
    def restricted(self) -> pulumi.Output[builtins.bool]:
        """
        A flag that indicates that other nodes may not be used to run resources associated to this HA group. Defaults to `false`.
        """
        return pulumi.get(self, "restricted")
