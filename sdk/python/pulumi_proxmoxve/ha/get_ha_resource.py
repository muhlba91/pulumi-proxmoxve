...
class GetHAResourceResult:
    ...
    def max_relocate(self) -> builtins.int:
        """
    ...
    def max_restart(self) -> builtins.int:
        """
...
def get_ha_resource(resource_id: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_id: The identifier of the Proxmox HA resource to read.
    """
    __args__ = dict()
...
def get_ha_resource_output(resource_id: Optional[pulumi.Input[builtins.str]] = None,
