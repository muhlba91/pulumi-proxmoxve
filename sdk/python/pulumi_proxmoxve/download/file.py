...
class FileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] overwrite: By default `true`. If `true` and file size has changed in the datastore, it will be replaced. If `false`, there will be no check.
...
class File(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        release20231228_debian12_bookworm_qcow2 = proxmoxve.download.File("release20231228Debian12BookwormQcow2",
            checksum="d2fbcf11fb28795842e91364d8c7b69f1870db09ff299eb94e4fbbfa510eb78d141e74c1f4bf6dfa0b7e33d0c3b66e6751886feadb4e9916f778bab1776bdf1b",
            checksum_algorithm="sha512",
            content_type="import",
            datastore_id="local",
        ...
        latest_debian12_bookworm_qcow2 = proxmoxve.download.File("latestDebian12BookwormQcow2",
            content_type="import",
            datastore_id="local",
