...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] user_id: The user identifier.
        :param pulumi.Input[Sequence[pulumi.Input['UserAclArgs']]] acls: The access control list (multiple blocks supported).
        :param pulumi.Input[builtins.str] comment: The user comment.
        :param pulumi.Input[builtins.str] email: The user's email address.
        :param pulumi.Input[builtins.bool] enabled: Whether the user account is enabled.
        :param pulumi.Input[builtins.str] expiration_date: The user account's expiration date (RFC 3339).
        :param pulumi.Input[builtins.str] first_name: The user's first name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups: The user's groups.
        :param pulumi.Input[builtins.str] keys: The user's keys.
        :param pulumi.Input[builtins.str] last_name: The user's last name.
        :param pulumi.Input[builtins.str] password: The user's password. Required for PVE or PAM realms.
        """
...
@pulumi.type_token("proxmoxve:Permission/user:User")
class User(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def keys(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user's keys.
        """
        return pulumi.get(self, "keys")
