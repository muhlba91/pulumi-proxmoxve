...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_id: The group identifier.
        :param pulumi.Input[Sequence[pulumi.Input['GroupAclArgs']]] acls: The access control list (multiple blocks supported).
        :param pulumi.Input[builtins.str] comment: The group comment.
        """
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: The group comment.
        :param pulumi.Input[builtins.str] group_id: The group identifier.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] members: The group members as a list of `username@realm` entries
        """
        if acls is not None:
            pulumi.set(__self__, "acls", acls)
        if comment is not None:
...
class Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            comment: Optional[pulumi.Input[builtins.str]] = None,
            group_id: Optional[pulumi.Input[builtins.str]] = None,
            members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Group':
        """
