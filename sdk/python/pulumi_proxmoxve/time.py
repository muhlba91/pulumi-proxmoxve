...
class TimeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_zone: The node's time zone.
        """
...
class _TimeState:
    def __init__(__self__, *,
                 local_time: Optional[pulumi.Input[builtins.str]] = None,
                 node_name: Optional[pulumi.Input[builtins.str]] = None,
                 time_zone: Optional[pulumi.Input[builtins.str]] = None,
                 utc_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Time resources.
        :param pulumi.Input[builtins.str] local_time: The node's local time.
        :param pulumi.Input[builtins.str] node_name: A node name.
        :param pulumi.Input[builtins.str] time_zone: The node's time zone.
        :param pulumi.Input[builtins.str] utc_time: The node's local time formatted as UTC.
        """
    ...
    def local_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @local_time.setter
    def local_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def utc_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @utc_time.setter
    def utc_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "utc_time", value)


@pulumi.type_token("proxmoxve:index/time:Time")
class Time(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            node_name: Optional[pulumi.Input[builtins.str]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            utc_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Time':
        """
    ...
    @property
    @pulumi.getter(name="localTime")
    def local_time(self) -> pulumi.Output[builtins.str]:
        """
        The node's local time.
        """
        return pulumi.get(self, "local_time")
    ...
    @property
    @pulumi.getter(name="utcTime")
    def utc_time(self) -> pulumi.Output[builtins.str]:
        """
        The node's local time formatted as UTC.
        """
        return pulumi.get(self, "utc_time")
