...
class ContainerArgs:
    def __init__(__self__, *,
                 ...
                 start_on_boot: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 timeout_delete: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_start: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_update: Optional[pulumi.Input[builtins.int]] = None,
                 unprivileged: Optional[pulumi.Input[builtins.bool]] = None,
                 vm_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Container resource.
        :param pulumi.Input[builtins.str] node_name: The name of the node to assign the container to.
        ...
        :param pulumi.Input[builtins.str] pool_id: The identifier for a pool to assign the container to.
        :param pulumi.Input[builtins.bool] protection: Whether to set the protection flag of the container (defaults to `false`). This will prevent the container itself and its disk for remove/update operations.
        :param pulumi.Input[builtins.bool] start_on_boot: Automatically start container when the host
               system boots (defaults to `true`).
        :param pulumi.Input[builtins.bool] started: Whether to start the container (defaults to `true`).
        :param pulumi.Input['ContainerStartupArgs'] startup: Defines startup and shutdown behavior of the container.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tags the container tags. This is only meta
        ...
        :param pulumi.Input[builtins.int] timeout_clone: Timeout for cloning a container in seconds (defaults to 1800).
        :param pulumi.Input[builtins.int] timeout_create: Timeout for creating a container in seconds (defaults to 1800).
        :param pulumi.Input[builtins.int] timeout_delete: Timeout for deleting a container in seconds (defaults to 60).
        :param pulumi.Input[builtins.int] timeout_start: Start container timeout
        :param pulumi.Input[builtins.int] timeout_update: Timeout for updating a container in seconds (defaults to 1800).
        :param pulumi.Input[builtins.bool] unprivileged: Whether the container runs as unprivileged on
               the host (defaults to `false`).
        :param pulumi.Input[builtins.int] vm_id: The container identifier
        """
    ...
    def start_on_boot(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def start_on_boot(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def timeout_delete(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_delete(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def timeout_start(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_start(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "timeout_start", value)

    @property
    @pulumi.getter(name="timeoutUpdate")
    def timeout_update(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_update(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "timeout_update", value)

    @property
    @pulumi.getter
    def unprivileged(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @unprivileged.setter
    def unprivileged(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Container(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timeout_update: Optional[pulumi.Input[builtins.int]] = None,
            unprivileged: Optional[pulumi.Input[builtins.bool]] = None,
            vm_id: Optional[pulumi.Input[builtins.int]] = None) -> 'Container':
        """
    ...
    @property
    @pulumi.getter(name="startOnBoot")
    def start_on_boot(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Automatically start container when the host
        system boots (defaults to `true`).
        """
    ...
    @property
    @pulumi.getter(name="timeoutDelete")
    def timeout_delete(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for deleting a container in seconds (defaults to 60).
        """
        return pulumi.get(self, "timeout_delete")
    ...
    @pulumi.getter(name="timeoutStart")
    @_utilities.deprecated("""This field is deprecated and will be removed in a future release. An overall operation timeout (`timeout_create` / `timeout_clone`) is used instead.""")
    def timeout_start(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Start container timeout
        """
        return pulumi.get(self, "timeout_start")
    ...
    @property
    @pulumi.getter(name="timeoutUpdate")
    def timeout_update(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for updating a container in seconds (defaults to 1800).
        """
        return pulumi.get(self, "timeout_update")
    ...
    @property
    @pulumi.getter
    def unprivileged(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the container runs as unprivileged on
        the host (defaults to `false`).
        """
