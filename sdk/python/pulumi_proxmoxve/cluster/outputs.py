...
class OptionsNextId(dict):
    def __init__(__self__, *,
                 lower: Optional[builtins.int] = None,
                 upper: Optional[builtins.int] = None):
        """
        :param builtins.int lower: The minimum number for the next free VM ID. Must be higher or equal to 100
        :param builtins.int upper: The maximum number for the next free VM ID. Must be less or equal to 999999999
        """
    ...
    @property
    @pulumi.getter
    def lower(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def upper(self) -> Optional[builtins.int]:
        """
...
class OptionsNotify(dict):
    ...
    def __init__(__self__, *,
                 ha_fencing_mode: Optional[builtins.str] = None,
                 ha_fencing_target: Optional[builtins.str] = None,
                 package_updates: Optional[builtins.str] = None,
                 package_updates_target: Optional[builtins.str] = None,
                 replication: Optional[builtins.str] = None,
                 replication_target: Optional[builtins.str] = None):
        """
        :param builtins.str ha_fencing_mode: Cluster-wide notification settings for the HA fencing mode. Must be `always` | `never`.
        :param builtins.str ha_fencing_target: Cluster-wide notification settings for the HA fencing target.
        :param builtins.str package_updates: Cluster-wide notification settings for package updates. Must be `auto` | `always` | `never`.
        :param builtins.str package_updates_target: Cluster-wide notification settings for the package updates target.
        :param builtins.str replication: Cluster-wide notification settings for replication. Must be `always` | `never`.
        :param builtins.str replication_target: Cluster-wide notification settings for the replication target.
        """
    ...
    def ha_fencing_mode(self) -> Optional[builtins.str]:
        """
    ...
    def ha_fencing_target(self) -> Optional[builtins.str]:
        """
    ...
    def package_updates(self) -> Optional[builtins.str]:
        """
    ...
    def package_updates_target(self) -> Optional[builtins.str]:
        """
    ...
    def replication_target(self) -> Optional[builtins.str]:
        """
