...
class AclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] path: Access control path
        :param pulumi.Input[builtins.str] role_id: The role to apply
        :param pulumi.Input[builtins.str] group_id: The group the ACL should apply to (mutually exclusive with `token_id` and `user_id`)
        :param pulumi.Input[builtins.bool] propagate: Allow to propagate (inherit) permissions.
        :param pulumi.Input[builtins.str] token_id: The token the ACL should apply to (mutually exclusive with `group_id` and `user_id`)
        :param pulumi.Input[builtins.str] user_id: The user the ACL should apply to (mutually exclusive with `group_id` and `token_id`)
        """
...
class Acl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_id: Optional[pulumi.Input[builtins.str]] = None,
            token_id: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Acl':
        """
    ...
    @property
    @pulumi.getter
    def propagate(self) -> pulumi.Output[builtins.bool]:
        """
        Allow to propagate (inherit) permissions.
        """
        return pulumi.get(self, "propagate")
    ...
    @property
    @pulumi.getter(name="tokenId")
    def token_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The token the ACL should apply to (mutually exclusive with `group_id` and `user_id`)
        """
        return pulumi.get(self, "token_id")
