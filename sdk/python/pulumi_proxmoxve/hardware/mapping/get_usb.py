...
def get_usb(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of this USB hardware mapping.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_usb_output(name: Optional[pulumi.Input[builtins.str]] = None,
