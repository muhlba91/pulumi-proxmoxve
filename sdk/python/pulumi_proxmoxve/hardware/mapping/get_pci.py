...
class GetPciResult:
    ...
    def mediated_devices(self) -> builtins.bool:
        """
...
def get_pci(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of this PCI hardware mapping.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_pci_output(name: Optional[pulumi.Input[builtins.str]] = None,
