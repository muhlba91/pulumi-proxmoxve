...
class FileArgs:
    def __init__(__self__, *,
                 ...
                 timeout_upload: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a File resource.
        :param pulumi.Input[builtins.str] datastore_id: The datastore id.
        :param pulumi.Input[builtins.str] node_name: The node name.
        :param pulumi.Input[builtins.str] content_type: The content type. If not specified, the content
               type will be inferred from the file extension. Valid values are:
        :param pulumi.Input[builtins.str] file_mode: The file mode in octal format, e.g. `0700` or `600`. Note that the prefixes `0o` and `0x` is not supported! Setting this attribute is also only allowed for `root@pam` authenticated user.
        :param pulumi.Input[builtins.bool] overwrite: Whether to overwrite an existing file (defaults to
               `true`).
        ...
        :param pulumi.Input[builtins.int] timeout_upload: Timeout for uploading ISO/VSTMPL files in
    ...
    def timeout_upload(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_upload(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _FileState:
    def __init__(__self__, *,
                 ...
                 file_mode: Optional[pulumi.Input[builtins.str]] = None,
                 file_modification_date: Optional[pulumi.Input[builtins.str]] = None,
                 file_name: Optional[pulumi.Input[builtins.str]] = None,
                 file_size: Optional[pulumi.Input[builtins.int]] = None,
                 file_tag: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] datastore_id: The datastore id.
        :param pulumi.Input[builtins.str] file_mode: The file mode in octal format, e.g. `0700` or `600`. Note that the prefixes `0o` and `0x` is not supported! Setting this attribute is also only allowed for `root@pam` authenticated user.
        :param pulumi.Input[builtins.str] file_modification_date: The file modification date (RFC 3339).
        :param pulumi.Input[builtins.str] file_name: The file name.
        :param pulumi.Input[builtins.int] file_size: The file size in bytes.
        :param pulumi.Input[builtins.str] file_tag: The file tag.
        :param pulumi.Input[builtins.str] node_name: The node name.
        :param pulumi.Input[builtins.bool] overwrite: Whether to overwrite an existing file (defaults to
               `true`).
        :param pulumi.Input['FileSourceFileArgs'] source_file: The source file (conflicts with `source_raw`),
    ...
    def file_modification_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def file_modification_date(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def file_tag(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The file tag.
        """
    ...
    @file_tag.setter
    def file_tag(self, value: Optional[pulumi.Input[builtins.str]]):
...
class File(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_file: Optional[pulumi.Input[Union['FileSourceFileArgs', 'FileSourceFileArgsDict']]] = None,
            source_raw: Optional[pulumi.Input[Union['FileSourceRawArgs', 'FileSourceRawArgsDict']]] = None,
            timeout_upload: Optional[pulumi.Input[builtins.int]] = None) -> 'File':
        """
    ...
    @property
    @pulumi.getter(name="fileMode")
    def file_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The file mode in octal format, e.g. `0700` or `600`. Note that the prefixes `0o` and `0x` is not supported! Setting this attribute is also only allowed for `root@pam` authenticated user.
        """
        return pulumi.get(self, "file_mode")
    ...
    @property
    @pulumi.getter(name="fileModificationDate")
    def file_modification_date(self) -> pulumi.Output[builtins.str]:
        """
        The file modification date (RFC 3339).
        """
        return pulumi.get(self, "file_modification_date")
    ...
    @property
    @pulumi.getter(name="fileTag")
    def file_tag(self) -> pulumi.Output[builtins.str]:
        """
        The file tag.
        """
        return pulumi.get(self, "file_tag")
    ...
    @property
    @pulumi.getter(name="timeoutUpload")
    def timeout_upload(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for uploading ISO/VSTMPL files in
        seconds (defaults to 1800).
        """
