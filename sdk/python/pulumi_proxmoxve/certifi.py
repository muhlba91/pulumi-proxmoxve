...
class CertifiArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate: The PEM encoded certificate.
        :param pulumi.Input[builtins.str] node_name: A node name.
        :param pulumi.Input[builtins.str] private_key: The PEM encoded private key.
        :param pulumi.Input[builtins.str] certificate_chain: The PEM encoded certificate chain.
        :param pulumi.Input[builtins.bool] overwrite: Whether to overwrite an existing certificate
        """
...
class _CertifiState:
    def __init__(__self__, *,
                 ...
                 public_key_size: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] certificate: The PEM encoded certificate.
        :param pulumi.Input[builtins.str] certificate_chain: The PEM encoded certificate chain.
        :param pulumi.Input[builtins.str] expiration_date: The expiration date (RFC 3339).
        :param pulumi.Input[builtins.str] file_name: The file name.
        :param pulumi.Input[builtins.str] issuer: The issuer.
        :param pulumi.Input[builtins.str] node_name: A node name.
        :param pulumi.Input[builtins.bool] overwrite: Whether to overwrite an existing certificate
        :param pulumi.Input[builtins.str] private_key: The PEM encoded private key.
        :param pulumi.Input[builtins.int] public_key_size: The public key size.
        :param pulumi.Input[builtins.str] public_key_type: The public key type.
        :param pulumi.Input[builtins.str] ssl_fingerprint: The SSL fingerprint.
        :param pulumi.Input[builtins.str] start_date: The start date (RFC 3339).
        :param pulumi.Input[builtins.str] subject: The subject.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subject_alternative_names: The subject alternative names.
        """
    ...
    def public_key_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The public key size.
        """
    ...
    def public_key_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Certifi(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            start_date: Optional[pulumi.Input[builtins.str]] = None,
            subject: Optional[pulumi.Input[builtins.str]] = None,
            subject_alternative_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Certifi':
        """
    ...
    @property
    @pulumi.getter(name="publicKeySize")
    def public_key_size(self) -> pulumi.Output[builtins.int]:
        """
        The public key size.
        """
        return pulumi.get(self, "public_key_size")
    ...
    @property
    @pulumi.getter(name="publicKeyType")
    def public_key_type(self) -> pulumi.Output[builtins.str]:
        """
        The public key type.
        """
        return pulumi.get(self, "public_key_type")
