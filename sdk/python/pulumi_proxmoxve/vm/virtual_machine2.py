...
class VirtualMachine2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] node_name: The name of the node where the VM is provisioned.
        ...
        :param pulumi.Input[builtins.str] description: The description of the VM.
        :param pulumi.Input[builtins.str] name: The name of the VM. Doesn't have to be unique.
        ...
        :param pulumi.Input[builtins.bool] stop_on_destroy: Set to true to stop (rather than shutdown) the VM on destroy (defaults to `false`).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The tags assigned to the VM.
        :param pulumi.Input[builtins.bool] template: Set to true to create a VM template.
...
@pulumi.type_token("proxmoxve:VM/virtualMachine2:VirtualMachine2")
class VirtualMachine2(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="stopOnDestroy")
    def stop_on_destroy(self) -> pulumi.Output[builtins.bool]:
        """
        Set to true to stop (rather than shutdown) the VM on destroy (defaults to `false`).
        """
        return pulumi.get(self, "stop_on_destroy")
