...
class VirtualMachineArgs:
    def __init__(__self__, *,
                 ...
                 hook_script_file_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 keyboard_layout: Optional[pulumi.Input[builtins.str]] = None,
                 kvm_arguments: Optional[pulumi.Input[builtins.str]] = None,
                 mac_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 machine: Optional[pulumi.Input[builtins.str]] = None,
                 memory: Optional[pulumi.Input['VirtualMachineMemoryArgs']] = None,
                 migrate: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 on_boot: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 protection: Optional[pulumi.Input[builtins.bool]] = None,
                 reboot: Optional[pulumi.Input[builtins.bool]] = None,
                 reboot_after_update: Optional[pulumi.Input[builtins.bool]] = None,
                 rngs: Optional[pulumi.Input[Sequence[pulumi.Input['VirtualMachineRngArgs']]]] = None,
                 scsi_hardware: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 stop_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 tablet_device: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 template: Optional[pulumi.Input[builtins.bool]] = None,
                 timeout_clone: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_create: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_migrate: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_move_disk: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_reboot: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_shutdown_vm: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_start_vm: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_stop_vm: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] node_name: The name of the node to assign the virtual machine
               to.
        ...
        :param pulumi.Input['VirtualMachineEfiDiskArgs'] efi_disk: The efi disk device (required if `bios` is set
               to `ovmf`)
        :param pulumi.Input[builtins.str] hook_script_file_id: The identifier for a file containing a hook script (needs to be executable, e.g. by using the `proxmox_virtual_environment_file.file_mode` attribute).
        ...
        :param pulumi.Input[builtins.str] keyboard_layout: The keyboard layout (defaults to `en-us`).
        :param pulumi.Input[builtins.str] kvm_arguments: Arbitrary arguments passed to kvm.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] mac_addresses: The MAC addresses published by the QEMU agent with fallback
               to the network device configuration, if the agent is disabled
        :param pulumi.Input[builtins.str] machine: The VM machine type (defaults to `pc`).
        :param pulumi.Input['VirtualMachineMemoryArgs'] memory: The memory configuration.
        :param pulumi.Input[builtins.bool] migrate: Migrate the VM on node change instead of re-creating
               it (defaults to `false`).
        :param pulumi.Input[builtins.str] name: The virtual machine name.
        ...
        :param pulumi.Input[builtins.bool] on_boot: Specifies whether a VM will be started during system
        ...
        :param pulumi.Input[builtins.str] pool_id: The identifier for a pool to assign the virtual machine to.
        :param pulumi.Input[builtins.bool] protection: Sets the protection flag of the VM. This will disable the remove VM and remove disk operations (defaults to `false`).
        :param pulumi.Input[builtins.bool] reboot: Reboot the VM after initial creation (defaults to `false`).
        :param pulumi.Input[builtins.bool] reboot_after_update: Reboot the VM after update if needed (defaults to `true`).
        ...
        :param pulumi.Input[builtins.str] scsi_hardware: The SCSI hardware type (defaults to
               `virtio-scsi-pci`).
        ...
        :param pulumi.Input[builtins.bool] started: Whether to start the virtual machine (defaults
               to `true`).
        :param pulumi.Input['VirtualMachineStartupArgs'] startup: Defines startup and shutdown behavior of the VM.
        :param pulumi.Input[builtins.bool] stop_on_destroy: Whether to stop rather than shutdown on VM destroy (defaults to `false`)
        :param pulumi.Input[builtins.bool] tablet_device: Whether to enable the USB tablet device (defaults
               to `true`).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tags of the VM. This is only meta information (
        ...
        :param pulumi.Input[builtins.bool] template: Whether to create a template (defaults to `false`).
        :param pulumi.Input[builtins.int] timeout_clone: Timeout for cloning a VM in seconds (defaults to
               1800).
        :param pulumi.Input[builtins.int] timeout_create: Timeout for creating a VM in seconds (defaults to
               1800).
        :param pulumi.Input[builtins.int] timeout_migrate: Timeout for migrating the VM (defaults to
               1800).
        :param pulumi.Input[builtins.int] timeout_move_disk: MoveDisk timeout
        :param pulumi.Input[builtins.int] timeout_reboot: Timeout for rebooting a VM in seconds (defaults
               to 1800).
        :param pulumi.Input[builtins.int] timeout_shutdown_vm: Timeout for shutting down a VM in seconds (
               defaults to 1800).
        :param pulumi.Input[builtins.int] timeout_start_vm: Timeout for starting a VM in seconds (defaults
               to 1800).
        :param pulumi.Input[builtins.int] timeout_stop_vm: Timeout for stopping a VM in seconds (defaults
               to 300).
        ...
        :param pulumi.Input[builtins.int] vm_id: The VM identifier.
    ...
    @property
    @pulumi.getter
    def acpi(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @acpi.setter
    def acpi(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def bios(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bios.setter
    def bios(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bios", value)

    @property
    @pulumi.getter(name="bootOrders")
    def boot_orders(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @boot_orders.setter
    def boot_orders(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def hook_script_file_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hook_script_file_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def keyboard_layout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def keyboard_layout(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "keyboard_layout", value)

    @property
    @pulumi.getter(name="kvmArguments")
    def kvm_arguments(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def kvm_arguments(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def machine(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @machine.setter
    def machine(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def migrate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @migrate.setter
    def migrate(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def on_boot(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @on_boot.setter
    def on_boot(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def protection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @protection.setter
    def protection(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def reboot_after_update(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reboot_after_update(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def scsi_hardware(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scsi_hardware(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def stop_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def stop_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "stop_on_destroy", value)

    @property
    @pulumi.getter(name="tabletDevice")
    def tablet_device(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def tablet_device(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def template(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @template.setter
    def template(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "template", value)

    @property
    @pulumi.getter(name="timeoutClone")
    def timeout_clone(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_clone(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "timeout_clone", value)

    @property
    @pulumi.getter(name="timeoutCreate")
    def timeout_create(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_create(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "timeout_create", value)

    @property
    @pulumi.getter(name="timeoutMigrate")
    def timeout_migrate(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_migrate(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def timeout_move_disk(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        MoveDisk timeout
        """
    ...
    def timeout_move_disk(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "timeout_move_disk", value)

    @property
    @pulumi.getter(name="timeoutReboot")
    def timeout_reboot(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_reboot(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "timeout_reboot", value)

    @property
    @pulumi.getter(name="timeoutShutdownVm")
    def timeout_shutdown_vm(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_shutdown_vm(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "timeout_shutdown_vm", value)

    @property
    @pulumi.getter(name="timeoutStartVm")
    def timeout_start_vm(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_start_vm(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "timeout_start_vm", value)

    @property
    @pulumi.getter(name="timeoutStopVm")
    def timeout_stop_vm(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def timeout_stop_vm(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _VirtualMachineState:
    def __init__(__self__, *,
                 ...
                 hostpcis: Optional[pulumi.Input[Sequence[pulumi.Input['VirtualMachineHostpciArgs']]]] = None,
                 initialization: Optional[pulumi.Input['VirtualMachineInitializationArgs']] = None,
                 ipv4_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]] = None,
                 ipv6_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]] = None,
                 keyboard_layout: Optional[pulumi.Input[builtins.str]] = None,
                 kvm_arguments: Optional[pulumi.Input[builtins.str]] = None,
                 mac_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 machine: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineHostpciArgs']]] hostpcis: A host PCI device mapping (multiple blocks supported).
        :param pulumi.Input['VirtualMachineInitializationArgs'] initialization: The cloud-init configuration.
        :param pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]] ipv4_addresses: The IPv4 addresses per network interface published by the
               QEMU agent (empty list when `agent.enabled` is `false`)
        :param pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]] ipv6_addresses: The IPv6 addresses per network interface published by the
               QEMU agent (empty list when `agent.enabled` is `false`)
        :param pulumi.Input[builtins.str] keyboard_layout: The keyboard layout (defaults to `en-us`).
        :param pulumi.Input[builtins.str] kvm_arguments: Arbitrary arguments passed to kvm.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] mac_addresses: The MAC addresses published by the QEMU agent with fallback
        ...
        :param pulumi.Input[builtins.str] name: The virtual machine name.
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineNetworkDeviceArgs']]] network_devices: A network device (multiple blocks supported).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_interface_names: The network interface names published by the QEMU
    ...
    def ipv4_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]:
        """
    ...
    def ipv4_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]):
        pulumi.set(self, "ipv4_addresses", value)

    @property
    @pulumi.getter(name="ipv6Addresses")
    def ipv6_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]:
        """
    ...
    def ipv6_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]):
...
class VirtualMachine(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def acpi(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable ACPI (defaults to `true`).
        """
        return pulumi.get(self, "acpi")
    ...
    @property
    @pulumi.getter
    def bios(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The BIOS implementation (defaults to `seabios`).
        """
        return pulumi.get(self, "bios")
    ...
    @property
    @pulumi.getter(name="bootOrders")
    def boot_orders(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specify a list of devices to boot from in the order
        they appear in the list (defaults to `[]`).
        """
    ...
    @property
    @pulumi.getter(name="hookScriptFileId")
    def hook_script_file_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The identifier for a file containing a hook script (needs to be executable, e.g. by using the `proxmox_virtual_environment_file.file_mode` attribute).
        """
        return pulumi.get(self, "hook_script_file_id")
    ...
    @property
    @pulumi.getter(name="ipv4Addresses")
    def ipv4_addresses(self) -> pulumi.Output[Sequence[Sequence[builtins.str]]]:
        """
        The IPv4 addresses per network interface published by the
        QEMU agent (empty list when `agent.enabled` is `false`)
        """
    ...
    @property
    @pulumi.getter(name="ipv6Addresses")
    def ipv6_addresses(self) -> pulumi.Output[Sequence[Sequence[builtins.str]]]:
        """
        The IPv6 addresses per network interface published by the
        QEMU agent (empty list when `agent.enabled` is `false`)
        """
    ...
    @property
    @pulumi.getter(name="keyboardLayout")
    def keyboard_layout(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The keyboard layout (defaults to `en-us`).
        """
        return pulumi.get(self, "keyboard_layout")
    ...
    @property
    @pulumi.getter(name="kvmArguments")
    def kvm_arguments(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Arbitrary arguments passed to kvm.
        """
        return pulumi.get(self, "kvm_arguments")
    ...
    @property
    @pulumi.getter
    def machine(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The VM machine type (defaults to `pc`).
        """
        return pulumi.get(self, "machine")
    ...
    @property
    @pulumi.getter
    def migrate(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Migrate the VM on node change instead of re-creating
        it (defaults to `false`).
        """
    ...
    @property
    @pulumi.getter(name="networkInterfaceNames")
    def network_interface_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The network interface names published by the QEMU
        agent (empty list when `agent.enabled` is `false`)
        """
    ...
    @property
    @pulumi.getter(name="onBoot")
    def on_boot(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether a VM will be started during system
        boot. (defaults to `true`)
        """
    ...
    @property
    @pulumi.getter(name="poolId")
    def pool_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The identifier for a pool to assign the virtual machine to.
        """
        return pulumi.get(self, "pool_id")
    ...
    @property
    @pulumi.getter
    def protection(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Sets the protection flag of the VM. This will disable the remove VM and remove disk operations (defaults to `false`).
        """
        return pulumi.get(self, "protection")
    ...
    @property
    @pulumi.getter(name="rebootAfterUpdate")
    def reboot_after_update(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Reboot the VM after update if needed (defaults to `true`).
        """
        return pulumi.get(self, "reboot_after_update")
    ...
    @property
    @pulumi.getter(name="scsiHardware")
    def scsi_hardware(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SCSI hardware type (defaults to
        `virtio-scsi-pci`).
        """
    ...
    @property
    @pulumi.getter
    def started(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to start the virtual machine (defaults
        to `true`).
        """
    ...
    @property
    @pulumi.getter(name="stopOnDestroy")
    def stop_on_destroy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to stop rather than shutdown on VM destroy (defaults to `false`)
        """
        return pulumi.get(self, "stop_on_destroy")
    ...
    @property
    @pulumi.getter(name="tabletDevice")
    def tablet_device(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable the USB tablet device (defaults
        to `true`).
        """
    ...
    @property
    @pulumi.getter
    def template(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to create a template (defaults to `false`).
        """
        return pulumi.get(self, "template")
    ...
    @property
    @pulumi.getter(name="timeoutClone")
    def timeout_clone(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for cloning a VM in seconds (defaults to
        1800).
        """
    ...
    @property
    @pulumi.getter(name="timeoutCreate")
    def timeout_create(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for creating a VM in seconds (defaults to
        1800).
        """
    ...
    @property
    @pulumi.getter(name="timeoutMigrate")
    def timeout_migrate(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for migrating the VM (defaults to
        1800).
        """
    ...
    @pulumi.getter(name="timeoutMoveDisk")
    @_utilities.deprecated("""This field is deprecated and will be removed in a future release. An overall operation timeout (timeout_create / timeout_clone / timeout_migrate) is used instead.""")
    def timeout_move_disk(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        MoveDisk timeout
        """
        return pulumi.get(self, "timeout_move_disk")
    ...
    @property
    @pulumi.getter(name="timeoutReboot")
    def timeout_reboot(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for rebooting a VM in seconds (defaults
        to 1800).
        """
    ...
    @property
    @pulumi.getter(name="timeoutShutdownVm")
    def timeout_shutdown_vm(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for shutting down a VM in seconds (
        defaults to 1800).
        """
    ...
    @property
    @pulumi.getter(name="timeoutStartVm")
    def timeout_start_vm(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for starting a VM in seconds (defaults
        to 1800).
        """
    ...
    @property
    @pulumi.getter(name="timeoutStopVm")
    def timeout_stop_vm(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout for stopping a VM in seconds (defaults
        to 300).
        """
    ...
    @property
    @pulumi.getter(name="vmId")
    def vm_id(self) -> pulumi.Output[builtins.int]:
        """
        The VM identifier.
        """
        return pulumi.get(self, "vm_id")
