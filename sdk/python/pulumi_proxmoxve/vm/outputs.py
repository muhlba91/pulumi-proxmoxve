...
class VirtualMachine2Cdrom(dict):
    ...
    def __init__(__self__, *,
                 file_id: Optional[builtins.str] = None):
        """
        :param builtins.str file_id: The file ID of the CD-ROM, or `cdrom|none`. Defaults to `none` to leave the CD-ROM empty. Use `cdrom` to connect to the physical drive.
        """
    ...
    def file_id(self) -> Optional[builtins.str]:
        """
...
class VirtualMachine2Cpu(dict):
    def __init__(__self__, *,
                 ...
                 hotplugged: Optional[builtins.int] = None,
                 limit: Optional[builtins.int] = None,
                 numa: Optional[builtins.bool] = None,
                 sockets: Optional[builtins.int] = None,
        ...
        :param builtins.str architecture: The CPU architecture `<aarch64 | x86_64>` (defaults to the host). Setting `affinity` is only allowed for `root@pam` authenticated user.
        :param builtins.int cores: The number of CPU cores per socket (defaults to `1`).
        :param Sequence[builtins.str] flags: Set of additional CPU flags. Use `+FLAG` to enable, `-FLAG` to disable a flag. Custom CPU models can specify any flag supported by QEMU/KVM, VM-specific flags must be from the following set for security reasons: `pcid`, `spec-ctrl`, `ibpb`, `ssbd`, `virt-ssbd`, `amd-ssbd`, `amd-no-ssb`, `pdpe1gb`, `md-clear`, `hv-tlbflush`, `hv-evmcs`, `aes`.
        :param builtins.int hotplugged: The number of hotplugged vCPUs (defaults to `0`).
        :param builtins.int limit: Limit of CPU usage (defaults to `0` which means no limit).
        :param builtins.bool numa: Enable NUMA (defaults to `false`).
        :param builtins.int sockets: The number of CPU sockets (defaults to `1`).
        :param builtins.str type: Emulated CPU type, it's recommended to use `x86-64-v2-AES` or higher (defaults to `kvm64`). See https://pve.proxmox.com/pve-docs/pve-admin-guide.html#qm*virtual*machines_settings for more information.
        :param builtins.int units: CPU weight for a VM. Argument is used in the kernel fair scheduler. The larger the number is, the more CPU time this VM gets. Number is relative to weights of all the other running VMs.
        """
    ...
    @property
    @pulumi.getter
    def hotplugged(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def numa(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def sockets(self) -> Optional[builtins.int]:
        """
...
class VirtualMachine2Rng(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_bytes: Maximum bytes of entropy allowed to get injected into the guest every period. Use 0 to disable limiting (potentially dangerous).
        :param builtins.int period: Period in milliseconds to limit entropy injection to the guest. Use 0 to disable limiting (potentially dangerous).
        :param builtins.str source: The file on the host to gather entropy from. In most cases, `/dev/urandom` should be preferred over `/dev/random` to avoid entropy-starvation issues on the host.
        """
...
class VirtualMachine2Vga(dict):
    def __init__(__self__, *,
                 clipboard: Optional[builtins.str] = None,
                 memory: Optional[builtins.int] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str clipboard: Enable a specific clipboard. If not set, depending on the display type the SPICE one will be added. Currently only `vnc` is available. Migration with VNC clipboard is not supported by Proxmox.
        :param builtins.int memory: The VGA memory in megabytes (4-512 MB). Has no effect with serial display.
        :param builtins.str type: The VGA type (defaults to `std`).
        """
    ...
    @property
    @pulumi.getter
    def clipboard(self) -> Optional[builtins.str]:
        """
...
class VirtualMachineAgent(dict):
    def __init__(__self__, *,
                 ...
                 trim: Optional[builtins.bool] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Whether to enable the QEMU agent (defaults
               to `false`).
        :param builtins.str timeout: The maximum amount of time to wait for data from
               the QEMU agent to become available ( defaults to `15m`).
        :param builtins.bool trim: Whether to enable the FSTRIM feature in the QEMU agent
               (defaults to `false`).
        :param builtins.str type: The QEMU agent interface type (defaults to `virtio`).
        """
    ...
    @property
    @pulumi.getter
    def trim(self) -> Optional[builtins.bool]:
        """
...
class VirtualMachineAudioDevice(dict):
    def __init__(__self__, *,
                 ...
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str device: The device (defaults to `intel-hda`).
               - `AC97` - Intel 82801AA AC97 Audio.
               - `ich9-intel-hda` - Intel HD Audio Controller (ich9).
               - `intel-hda` - Intel HD Audio.
        :param builtins.str driver: The driver (defaults to `spice`).
        :param builtins.bool enabled: Whether to enable the audio device (defaults
               to `true`).
        """
...
class VirtualMachineCdrom(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Whether to enable the CD-ROM drive (defaults
...
class VirtualMachineClone(dict):
    ...
    def __init__(__self__, *,
                 ...
                 full: Optional[builtins.bool] = None,
                 node_name: Optional[builtins.str] = None,
                 retries: Optional[builtins.int] = None):
        """
        :param builtins.int vm_id: The identifier for the source VM.
        :param builtins.str datastore_id: The identifier for the target datastore.
        :param builtins.bool full: Full or linked clone (defaults to `true`).
        :param builtins.str node_name: The name of the source node (leave blank, if
               equal to the `node_name` argument).
        :param builtins.int retries: Number of retries in Proxmox for clone vm.
    ...
    @property
    @pulumi.getter
    def full(self) -> Optional[builtins.bool]:
        """
...
class VirtualMachineCpu(dict):
    def __init__(__self__, *,
                 ...
                 units: Optional[builtins.int] = None):
        """
        :param builtins.str affinity: The CPU cores that are used to run the VM’s vCPU. The
        ...
        :param builtins.str architecture: The CPU architecture (defaults to `x86_64`).
        :param builtins.int cores: The number of CPU cores (defaults to `1`).
        :param Sequence[builtins.str] flags: The CPU flags.
        ...
        :param builtins.int hotplugged: The number of hotplugged vCPUs (defaults
               to `0`).
        :param builtins.int limit: Limit of CPU usage, `0...128`. (defaults to `0` -- no limit).
        :param builtins.bool numa: Enable/disable NUMA. (default to `false`)
        :param builtins.int sockets: The number of CPU sockets (defaults to `1`).
        :param builtins.str type: The emulated CPU type, it's recommended to
...
class VirtualMachineDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 aio: Optional[builtins.str] = None,
                 backup: Optional[builtins.bool] = None,
                 cache: Optional[builtins.str] = None,
                 datastore_id: Optional[builtins.str] = None,
                 discard: Optional[builtins.str] = None,
                 file_format: Optional[builtins.str] = None,
                 file_id: Optional[builtins.str] = None,
                 iothread: Optional[builtins.bool] = None,
                 path_in_datastore: Optional[builtins.str] = None,
                 ...
                 ssd: Optional[builtins.bool] = None):
        """
        :param builtins.str interface: The disk interface for Proxmox, currently `scsi`,
               `sata` and `virtio` interfaces are supported. Append the disk index at
               the end, for example, `virtio0` for the first virtio disk, `virtio1` for
               the second, etc.
        :param builtins.str aio: The disk AIO mode (defaults to `io_uring`).
        :param builtins.bool backup: Whether the drive should be included when making backups (defaults to `true`).
        :param builtins.str cache: The cache type (defaults to `none`).
        :param builtins.str datastore_id: The identifier for the datastore to create
               the disk in (defaults to `local-lvm`).
        :param builtins.str discard: Whether to pass discard/trim requests to the
               underlying storage. Supported values are `on`/`ignore` (defaults
               to `ignore`).
        :param builtins.str file_format: The file format.
        :param builtins.str file_id: The file ID for a disk image when importing a disk into VM. The ID format is
               `<datastore_id>:<content_type>/<file_name>`, for example `local:iso/centos8.img`. Can be also taken from
               `Download.File` resource.
        :param builtins.bool iothread: Whether to use iothreads for this disk (defaults
               to `false`).
        :param builtins.str path_in_datastore: The in-datastore path to the disk image.
               ***Experimental.***Use to attach another VM's disks,
               or (as root only) host's filesystem paths (`datastore_id` empty string).
               See "*Example: Attached disks*".
        :param builtins.bool replicate: Whether the drive should be considered for replication jobs (defaults to `true`).
        :param builtins.str serial: The serial number of the disk, up to 20 bytes long.
        :param builtins.int size: The disk size in gigabytes (defaults to `8`).
        :param 'VirtualMachineDiskSpeedArgs' speed: The speed limits.
        :param builtins.bool ssd: Whether to use an SSD emulation option for this disk (
    ...
    @property
    @pulumi.getter
    def aio(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def discard(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def iothread(self) -> Optional[builtins.bool]:
        """
    ...
    def path_in_datastore(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def ssd(self) -> Optional[builtins.bool]:
        """
...
class VirtualMachineDiskSpeed(dict):
    ...
    def __init__(__self__, *,
                 iops_read: Optional[builtins.int] = None,
                 iops_read_burstable: Optional[builtins.int] = None,
                 iops_write: Optional[builtins.int] = None,
                 iops_write_burstable: Optional[builtins.int] = None,
                 read: Optional[builtins.int] = None,
                 read_burstable: Optional[builtins.int] = None,
                 write: Optional[builtins.int] = None,
                 write_burstable: Optional[builtins.int] = None):
        """
        :param builtins.int iops_read: The maximum read I/O in operations per second.
        :param builtins.int iops_read_burstable: The maximum unthrottled read I/O pool in operations per second.
        :param builtins.int iops_write: The maximum write I/O in operations per second.
        :param builtins.int iops_write_burstable: The maximum unthrottled write I/O pool in operations per second.
        :param builtins.int read: The maximum read speed in megabytes per second.
        :param builtins.int read_burstable: The maximum burstable read speed in
               megabytes per second.
        :param builtins.int write: The maximum write speed in megabytes per second.
        :param builtins.int write_burstable: The maximum burstable write speed in
               megabytes per second.
        """
    ...
    def iops_read(self) -> Optional[builtins.int]:
        """
    ...
    def iops_read_burstable(self) -> Optional[builtins.int]:
        """
    ...
    def iops_write(self) -> Optional[builtins.int]:
        """
    ...
    def iops_write_burstable(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def read(self) -> Optional[builtins.int]:
        """
    ...
    def read_burstable(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def write(self) -> Optional[builtins.int]:
        """
    ...
    def write_burstable(self) -> Optional[builtins.int]:
        """
...
class VirtualMachineEfiDisk(dict):
    ...
    def __init__(__self__, *,
                 datastore_id: Optional[builtins.str] = None,
                 file_format: Optional[builtins.str] = None,
                 pre_enrolled_keys: Optional[builtins.bool] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str datastore_id: The identifier for the datastore to create
               the disk in (defaults to `local-lvm`).
        :param builtins.str file_format: The file format (defaults to `raw`).
        :param builtins.bool pre_enrolled_keys: Use am EFI vars template with
               distribution-specific and Microsoft Standard keys enrolled, if used with
               EFI type=`4m`. Ignored for VMs with cpu.architecture=`aarch64` (defaults
               to `false`).
        :param builtins.str type: Size and type of the OVMF EFI disk. `4m` is newer and
    ...
    def pre_enrolled_keys(self) -> Optional[builtins.bool]:
        """
...
class VirtualMachineHostpci(dict):
    ...
    def __init__(__self__, *,
                 ...
                 mdev: Optional[builtins.str] = None,
                 pcie: Optional[builtins.bool] = None,
                 rom_file: Optional[builtins.str] = None,
                 rombar: Optional[builtins.bool] = None,
                 xvga: Optional[builtins.bool] = None):
        """
        :param builtins.str device: The PCI device name for Proxmox, in form
               of `hostpciX` where `X` is a sequential number from 0 to 15.
        :param builtins.str id: The PCI device ID. This parameter is not compatible
               with `api_token` and requires the root `username` and `password`
               configured in the proxmox provider. Use either this or `mapping`.
        :param builtins.str mapping: The resource mapping name of the device, for
               example gpu. Use either this or `id`.
        :param builtins.str mdev: The mediated device ID to use.
        :param builtins.bool pcie: Tells Proxmox to use a PCIe or PCI port. Some
               guests/device combination require PCIe rather than PCI. PCIe is only
               available for q35 machine types.
        :param builtins.str rom_file: A path to a ROM file for the device to use. This
               is a relative path under `/usr/share/kvm/`.
        :param builtins.bool rombar: Makes the firmware ROM visible for the VM (defaults
               to `true`).
        :param builtins.bool xvga: Marks the PCI(e) device as the primary GPU of the VM.
    ...
    @property
    @pulumi.getter
    def mdev(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def pcie(self) -> Optional[builtins.bool]:
        """
    ...
    def rom_file(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def rombar(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def xvga(self) -> Optional[builtins.bool]:
        """
...
class VirtualMachineInitialization(dict):
    ...
    def __init__(__self__, *,
                 ...
                 meta_data_file_id: Optional[builtins.str] = None,
                 network_data_file_id: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None,
                 user_account: Optional['outputs.VirtualMachineInitializationUserAccount'] = None,
                 user_data_file_id: Optional[builtins.str] = None,
                 vendor_data_file_id: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str interface: The hardware interface to connect the cloud-init
        ...
        :param Sequence['VirtualMachineInitializationIpConfigArgs'] ip_configs: The IP configuration (one block per network
               device).
        :param builtins.str meta_data_file_id: The identifier for a file containing
               all meta data passed to the VM via cloud-init.
        :param builtins.str network_data_file_id: The identifier for a file containing
               network configuration data passed to the VM via cloud-init (conflicts
               with `ip_config`).
        :param builtins.str type: The cloud-init configuration format
        :param 'VirtualMachineInitializationUserAccountArgs' user_account: The user account configuration (conflicts
               with `user_data_file_id`).
        :param builtins.str user_data_file_id: The identifier for a file containing
               custom user data (conflicts with `user_account`).
        :param builtins.str vendor_data_file_id: The identifier for a file containing
    ...
    def meta_data_file_id(self) -> Optional[builtins.str]:
        """
    ...
    def network_data_file_id(self) -> Optional[builtins.str]:
        """
        The identifier for a file containing
        network configuration data passed to the VM via cloud-init (conflicts
        with `ip_config`).
    ...
    def user_data_file_id(self) -> Optional[builtins.str]:
        """
        The identifier for a file containing
        custom user data (conflicts with `user_account`).
        """
    ...
    def vendor_data_file_id(self) -> Optional[builtins.str]:
        """
        The identifier for a file containing
        all vendor data passed to the VM via cloud-init.
        """
...
class VirtualMachineInitializationIpConfigIpv6(dict):
    def __init__(__self__, *,
                 ...
                 gateway: Optional[builtins.str] = None):
        """
        :param builtins.str address: The IPv6 address in CIDR notation
...
class VirtualMachineInitializationUserAccount(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] keys: The SSH keys.
        :param builtins.str password: The SSH password.
        :param builtins.str username: The SSH username.
        """
        if keys is not None:
...
class VirtualMachineMemory(dict):
    ...
    def __init__(__self__, *,
                 ...
                 floating: Optional[builtins.int] = None,
                 hugepages: Optional[builtins.str] = None,
                 keep_hugepages: Optional[builtins.bool] = None,
                 shared: Optional[builtins.int] = None):
        """
        :param builtins.int dedicated: The dedicated memory in megabytes (defaults to `512`).
        :param builtins.int floating: The floating memory in megabytes. The default is `0`, which disables "ballooning device" for the VM.
        ...
        :param builtins.str hugepages: Enable/disable hugepages memory (defaults to disable).
        :param builtins.bool keep_hugepages: Keep hugepages memory after the VM is stopped (defaults to `false`).
        ...
        :param builtins.int shared: The shared memory in megabytes (defaults to `0`).
        """
    ...
    @property
    @pulumi.getter
    def floating(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def hugepages(self) -> Optional[builtins.str]:
        """
    ...
    def keep_hugepages(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def shared(self) -> Optional[builtins.int]:
        """
...
class VirtualMachineNetworkDevice(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disconnected: Optional[builtins.bool] = None,
                 enabled: Optional[builtins.bool] = None,
                 ...
                 trunks: Optional[builtins.str] = None,
                 vlan_id: Optional[builtins.int] = None):
        """
        :param builtins.str bridge: The name of the network bridge (defaults to `vmbr0`).
        :param builtins.bool disconnected: Whether to disconnect the network device from the network (defaults to `false`).
        :param builtins.bool enabled: Whether to enable the network device (defaults to `true`).
        :param builtins.bool firewall: Whether this interface's firewall rules should be used (defaults to `false`).
        :param builtins.str mac_address: The MAC address.
        :param builtins.str model: The network device model (defaults to `virtio`).
        :param builtins.int mtu: Force MTU, for VirtIO only. Set to 1 to use the bridge MTU. Cannot be larger than the bridge MTU.
        :param builtins.int queues: The number of queues for VirtIO (1..64).
        :param builtins.float rate_limit: The rate limit in megabytes per second.
        :param builtins.str trunks: String containing a `;` separated list of VLAN trunks
    ...
    @property
    @pulumi.getter
    def disconnected(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def trunks(self) -> Optional[builtins.str]:
        """
...
class VirtualMachineNuma(dict):
    def __init__(__self__, *,
                 ...
                 device: builtins.str,
                 memory: builtins.int,
                 hostnodes: Optional[builtins.str] = None,
                 policy: Optional[builtins.str] = None):
        """
        :param builtins.str cpus: The CPU cores to assign to the NUMA node (format is `0-7;16-31`).
        :param builtins.str device: The NUMA device name for Proxmox, in form
               of `numaX` where `X` is a sequential number from 0 to 7.
        :param builtins.int memory: The memory in megabytes to assign to the NUMA node.
        :param builtins.str hostnodes: The NUMA host nodes.
        :param builtins.str policy: The NUMA policy (defaults to `preferred`).
        """
    ...
    @property
    @pulumi.getter
    def hostnodes(self) -> Optional[builtins.str]:
        """
        The NUMA host nodes.
        """
...
class VirtualMachineOperatingSystem(dict):
    def __init__(__self__, *,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str type: The type (defaults to `other`).
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class VirtualMachineRng(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str source: The file on the host to gather entropy from. In most cases, `/dev/urandom` should be preferred over `/dev/random` to avoid entropy-starvation issues on the host.
        :param builtins.int max_bytes: Maximum bytes of entropy allowed to get injected into the guest every `period` milliseconds (defaults to `1024`). Prefer a lower value when using `/dev/random` as source.
        :param builtins.int period: Every `period` milliseconds the entropy-injection quota is reset, allowing the guest to retrieve another `max_bytes` of entropy (defaults to `1000`).
        """
        pulumi.set(__self__, "source", source)
        if max_bytes is not None:
            pulumi.set(__self__, "max_bytes", max_bytes)
...
class VirtualMachineSerialDevice(dict):
    def __init__(__self__, *,
                 device: Optional[builtins.str] = None):
        """
        :param builtins.str device: The device (defaults to `socket`).
...
class VirtualMachineSmbios(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str family: The family string.
        :param builtins.str manufacturer: The manufacturer.
        :param builtins.str product: The product ID.
        :param builtins.str serial: The serial number.
        :param builtins.str sku: The SKU number.
        :param builtins.str uuid: The UUID (defaults to randomly generated UUID).
...
class VirtualMachineTpmState(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str datastore_id: The identifier for the datastore to create
               the disk in (defaults to `local-lvm`).
        :param builtins.str version: TPM state device version. Can be `v1.2` or `v2.0`.
               (defaults to `v2.0`).
        """
        if datastore_id is not None:
            pulumi.set(__self__, "datastore_id", datastore_id)
...
class VirtualMachineUsb(dict):
    def __init__(__self__, *,
                 ...
                 mapping: Optional[builtins.str] = None,
                 usb3: Optional[builtins.bool] = None):
        """
        :param builtins.str host: The Host USB device or port or the value `spice`. Use either this or `mapping`.
        :param builtins.str mapping: The cluster-wide resource mapping name of the device, for example "usbdevice". Use either this or `host`.
        :param builtins.bool usb3: Makes the USB device a USB3 device for the VM
               (defaults to `false`).
        """
        if host is not None:
    ...
    @property
    @pulumi.getter
    def usb3(self) -> Optional[builtins.bool]:
        """
...
class VirtualMachineVga(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str clipboard: Enable VNC clipboard by setting to `vnc`. See the [Proxmox documentation](https://pve.proxmox.com/pve-docs/pve-admin-guide.html#qm_virtual_machines_settings) section 10.2.8 for more information.
        :param builtins.int memory: The VGA memory in megabytes (defaults to `16`).
        :param builtins.str type: The VGA type (defaults to `std`).
        """
        if clipboard is not None:
            pulumi.set(__self__, "clipboard", clipboard)
...
class VirtualMachineVirtiof(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cache: Optional[builtins.str] = None,
                 direct_io: Optional[builtins.bool] = None,
                 expose_acl: Optional[builtins.bool] = None,
                 expose_xattr: Optional[builtins.bool] = None):
        """
        :param builtins.str mapping: Identifier of the directory mapping
        :param builtins.str cache: The caching mode
        :param builtins.bool direct_io: Whether to allow direct io
        :param builtins.bool expose_acl: Enable POSIX ACLs, implies xattr support
        :param builtins.bool expose_xattr: Enable support for extended attributes
        """
        pulumi.set(__self__, "mapping", mapping)
        if cache is not None:
            pulumi.set(__self__, "cache", cache)
    ...
    def direct_io(self) -> Optional[builtins.bool]:
        """
    ...
    def expose_acl(self) -> Optional[builtins.bool]:
        """
    ...
    def expose_xattr(self) -> Optional[builtins.bool]:
        """
...
class VirtualMachineWatchdog(dict):
    def __init__(__self__, *,
                 ...
                 model: Optional[builtins.str] = None):
        """
        :param builtins.str action: The action to perform if after activation the guest fails to poll the watchdog in time  (defaults to `none`).
        :param builtins.bool enabled: Whether the watchdog is enabled (defaults to `false`).
        :param builtins.str model: The watchdog type to emulate (defaults to `i6300esb`).
        """
...
class GetVirtualMachinesVmResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The virtual machine name.
        ...
        :param builtins.int vm_id: The VM identifier.
        :param builtins.str status: Status of the VM
        :param builtins.bool template: Is VM a template (true) or a regular VM (false)
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "node_name", node_name)
