...
class IpsetLegacyCidrArgsDict(TypedDict):
    ...
    """
    nomatch: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class IpsetLegacyCidrArgs:
    def __init__(__self__, *,
                 ...
                 nomatch: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def nomatch(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Entries marked as `nomatch` are skipped as if those
        were not added to the set.
        """
    ...
    @nomatch.setter
    def nomatch(self, value: pulumi.Input[Optional[_builtins.bool]]):
