...
class _HostsState:
    def __init__(__self__, *,
                 ...
                 hostnames: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]] = None,
                 node_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Hosts resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] addresses: The IP addresses.
        :param pulumi.Input[builtins.str] digest: The SHA1 digest.
        :param pulumi.Input[Sequence[pulumi.Input['HostsEntryArgs']]] entries: The host entries (conversion of `addresses` and `hostnames` into
               objects).
        :param pulumi.Input[Sequence[pulumi.Input['HostsEntryArgs']]] entry: A host entry (multiple blocks supported).
        :param pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]] hostnames: The hostnames associated with each of the IP addresses.
        :param pulumi.Input[builtins.str] node_name: A node name.
        """
    ...
    @property
    @pulumi.getter
    def hostnames(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]:
        """
    ...
    @hostnames.setter
    def hostnames(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]):
...
class Hosts(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            entry: Optional[pulumi.Input[Sequence[pulumi.Input[Union['HostsEntryArgs', 'HostsEntryArgsDict']]]]] = None,
            hostnames: Optional[pulumi.Input[Sequence[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]] = None,
            node_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Hosts':
        """
    ...
    @property
    @pulumi.getter
    def hostnames(self) -> pulumi.Output[Sequence[Sequence[builtins.str]]]:
        """
        The hostnames associated with each of the IP addresses.
        """
        return pulumi.get(self, "hostnames")
